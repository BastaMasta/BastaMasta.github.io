/* BURRITO DROP — an original CHIP-8 game, written in CHIP-8 assembly.

   Catch the falling burrito on the paddle. Keys 4 and 6 move (the classic
   CHIP-8 keypad layout); the score digit sits top-left and wraps at 10.
